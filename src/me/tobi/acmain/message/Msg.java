...
public class Msg {
	...
	public static final String PLUGIN_ENABLED = "§eArdaCraft Hauptplugin §aaktiviert§e!";
	public static final String EVENT_JOIN_WELCOME = "§a§lHerzlich Willkommen auf §e§lArdaCraft";
	public static final String COMMAND_PLAYER_ONLY = "Dieser Befehl ist nur für Spieler!";
	public static final String COMMAND_NO_PERMISSION = "Du hast keine Berechtigung für diesen Befehl";
	public static final String COMMAND_REGISTER_USAGE = "Benutzung: /register <Player> <Rasse> <Charakter>";
